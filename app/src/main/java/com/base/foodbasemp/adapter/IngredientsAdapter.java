...
import com.base.foodbasemp.model.ExtendedIngredient;
...
public class IngredientsAdapter  extends  RecyclerView.Adapter<IngredientsAdapter.IngredientsViewHolder>{
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        holder.textView_ingredients_quantitiy.setText(list.get(position).original);
        holder.textView_ingredients_quantitiy.setSelected(true);
    ...
    class IngredientsViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView textView_ingredients_quantitiy , textView_ingredients_name;
        ImageView imageView_ingredients;

        public IngredientsViewHolder(@NonNull View itemView) {
            super(itemView);

            textView_ingredients_quantitiy = itemView.findViewById(R.id.textView_ingredients_quantitiy);
